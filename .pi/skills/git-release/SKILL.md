   ---
   name: git-release
   description: Creates GitHub releases with automated changelog generation
 from git commit history. Use when preparing, drafting, or publishing a new
 project release or version tag.
